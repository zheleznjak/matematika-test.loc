              ...
              <ul class="nav navbar-nav">
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="/country">View</a></li>
                    <li><a href="/api/country/create">Create</a></li>
                  </ul>
                </li>
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="/city">View</a></li>
                    <li><a href="/api/city/create">Create</a></li>
                  </ul>
                </li>
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Language <span class="caret"></span></a>
                  <ul class="dropdown-menu">
                    <li><a href="/language">View</a></li>
                    <li><a href="/api/language/create">Create</a></li>
                  </ul>
                </li>
              </ul>
            </div>
